...
/******************************************************************************************************************/
/******************************************************************************************************************/
template <typename T, int row, int column>   //row by column by depth
class matrix2d
{
	public:
	...
	T operator()(const int i, const int j) const {return mat2[i*column+j];}
	T& operator()(const int i,const int j) {return mat2[i*column+j];}
